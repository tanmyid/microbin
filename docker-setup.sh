...
mkdir -p $install_dir
cd $install_dir
$download_command https://raw.githubusercontent.com/tanmyid/microbin/master/.env
$download_command https://raw.githubusercontent.com/tanmyid/microbin/master/compose.yaml
